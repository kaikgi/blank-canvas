...
begin
  ...
  if new.status = 'trial' and (new.plano is null or new.plano = '' or new.plano = 'nenhum' or new.plano = 'studio') then
    new.plano := 'trial';
  end if;
...
-- Update existing trial establishments to have plano='trial'
UPDATE public.establishments SET plano = 'trial' WHERE status = 'trial' AND plano = 'studio';
